...
# 1️⃣ Ma trận nhầm lẫn
conf_matrix = confusion_matrix(y_test, y_pred)
plt.figure(figsize=(6, 4))
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Blues', xticklabels=['Không phải spam', 'Spam'], yticklabels=['Không phải spam', 'Spam'])
...
dump(rf_model, 'random_forest_model.joblib')  # Lưu mô hình vào file